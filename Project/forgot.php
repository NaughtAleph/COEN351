		...
		if($rows>0) { ?>
			<div class='container my-container'> 
				<form method='POST'>
					...
					<br>
					<p>Click here to try again <a href='forgot.php'>Login</a></p>
				</form>
			</div>
		<?php }
		else
	...
	<div class="form">
		<div class="container my-container">
			<form method="POST" action="">
				...
				<hr>
				<h5><strong><em><u>Forgot Password</u></h5>
				<hr>
